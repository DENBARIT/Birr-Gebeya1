...
//   }
// }
// telebirr_connection_success_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart'; // 1. IMPORT PROVIDER
import '../models/app_state.dart'; // 2. IMPORT APPSTATE
import '../theme/design_system.dart';
import 'kyc_profile_setup_screen.dart';
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    // 3. COMMIT THE VALUE TO THE CENTRAL STATE PROVIDER FIRST
                    Provider.of<AppState>(
                      context,
                      listen: false,
                    ).connectTelebirr(telebirrNumber);
